    ...
    : QMainWindow(parent), ui(new Ui::AccountListPage)
{
    ...
    ui->listView->setEmptyString(tr(
        "Welcome!\n"
        "If you're new here, select add offline. This launcher is entirely offline and will not pull from curseforge."
    ));
...
void AccountListPage::on_actionAddOffline_triggered()
{
    ...
    MinecraftAccountPtr account = OfflineLoginDialog::newAccount(
        this,
        tr("Please enter your desired username to add your cracked account.")
    );
